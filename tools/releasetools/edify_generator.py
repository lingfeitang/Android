...
class EdifyGenerator(object):
  ...
  def AssertDevice(self, device):
    ...
    if device == "sp7731g_1h10" or device == "sp7731g_1h10_32v4":
      cmd = ('getprop("ro.product.device") == "%s" || '
           'getprop("ro.product.device") == "scx35_sp7731gea_hd" ||'
           'getprop("ro.product.device") == "scx35_sp7731gea_hdr" ||'
           'getprop("ro.product.device") == "scx35_sp7731gea" ||'
           'abort("This package is for \\"%s\\" devices; '
           'this is a \\"" + getprop("ro.product.device") + "\\".");') % (
               device, device)
    elif device == "sp9830a_5h10" or device == "sp9830a_5h10_volte" or device == "sp9830a_5h10_32v4":
      cmd = ('getprop("ro.product.device") == "%s" || '
           'getprop("ro.product.device") == "sp9830aef_5m_volte" ||'
           'getprop("ro.product.device") == "sp9830aea_5m_h100" ||'
           'abort("This package is for \\"%s\\" devices; '
           'this is a \\"" + getprop("ro.product.device") + "\\".");') % (
               device, device)
    elif device == "sp9830a_7h10" or device == "sp9830a_7h10_volte":
      cmd = ('getprop("ro.product.device") == "%s" || '
           'getprop("ro.product.device") == "sp9830aed5mvolte" ||'
           'getprop("ro.product.device") == "sp9830aed_5m_h100" ||'
           'abort("This package is for \\"%s\\" devices; '
           'this is a \\"" + getprop("ro.product.device") + "\\".");') % (
               device, device)
    elif device == "sp9832a_2h10" or device == "sp9832a_2h11" or device == "sp9832a_2h11_volte" or device == "sp9830i_2h11":
      cmd = ('getprop("ro.product.device") == "%s" || '
           'getprop("ro.product.device") == "sp9832iea_4m_h100" ||'
           'getprop("ro.product.device") == "sp9830ied_4m_h110" ||'
           'getprop("ro.product.device") == "sp9832iea_4m_volte" ||'
           'getprop("ro.product.device") == "sp9832a_2h11_volte" ||'
           'getprop("ro.product.device") == "sp9832a_2h11" ||'
           'abort("This package is for \\"%s\\" devices; '
           'this is a \\"" + getprop("ro.product.device") + "\\".");') % (
               device, device)
    elif device == "sp9832a_3h10" or device == "sp9832a_3h10_volte" or device == "sp9832a_3h10_cmcc":
      cmd = ('getprop("ro.product.device") == "%s" || '
           'getprop("ro.product.device") == "sp9832a_3h10" ||'
           'getprop("ro.product.device") == "sp9832a_3h10_volte" ||'
           'abort("This package is for \\"%s\\" devices; '
           'this is a \\"" + getprop("ro.product.device") + "\\".");') % (
               device, device)
    elif device == "sp7731c_1h10" or device == "sp7731c_1h10_32v4":
      cmd = ('getprop("ro.product.device") == "%s" || '
           'getprop("ro.product.device") == "scx20_sp7720eb" ||'
           'getprop("ro.product.device") == "scx20_sp7720ea" ||'
           'getprop("ro.product.device") == "scx20_sp7731cea" ||'
           'getprop("ro.product.device") == "scx20_sp7731ceb" ||'
           'abort("This package is for \\"%s\\" devices; '
           'this is a \\"" + getprop("ro.product.device") + "\\".");') % (
               device, device)
    else:
