...
""" % bcb_dev)
  ...
  if system_src.GetTotalBlocks() > system_tgt.GetTotalBlocks():
    print "source system img size bigger than target system image size..."
    system_diff.WriteScript(script, output_zip,
  ...
  if system_src.GetTotalBlocks() <= system_tgt.GetTotalBlocks():
    print "source system img size is NOT bigger than target system image size..."
    system_diff.WriteScript(script, output_zip,
                          progress=0.8 if vendor_diff else 0.9)
