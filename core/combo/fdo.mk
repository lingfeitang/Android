...
$(combo_2nd_arch_prefix)TARGET_FDO_INSTRUMENT_LDFLAGS := -u__llvm_profile_runtime vendor/google_data/lib/libclang_rt.profile-$(TARGET_$(combo_2nd_arch_prefix)ARCH)-android.a

ifneq (,$(findstring sp9861e, $(TARGET_PRODUCT)))
        FDO_PROFILE_PATH := device/sprd/iwhale2/fdo_profile
        BUILD_FDO_OPTIMIZE ?= true
else
        FDO_PROFILE_PATH := vendor/google_data/fdo_profile
endif

# Set TARGET_FDO_PROFILE_PATH to set a custom profile directory for your build.
ifeq ($(strip $($(combo_2nd_arch_prefix)TARGET_FDO_PROFILE_PATH)),)
  $(combo_2nd_arch_prefix)TARGET_FDO_PROFILE_PATH := $(FDO_PROFILE_PATH)
endif
