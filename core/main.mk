...
$(shell mkdir -p $(TARGET_MINROOT_OUT))
ifeq ($(TARGET_ARCH),x86_64)
        $(shell cp -r -f build/minroot_x86/* $(TARGET_MINROOT_OUT))
else
        $(shell cp -r -f build/minroot_arm/* $(TARGET_MINROOT_OUT))
endif
...
.PHONY: bootimage
bootimage: $(INSTALLED_BOOTIMAGE_TARGET) $(INSTALLED_MINBOOTIMAGE_TARGET)
...
$(if $(filter true,$(FOTA_UPDATE_SUPPORT)), droid: img-target-files)
